...
const FeaturesCards = (): JSX.Element => {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-3 lg:grid-rows-1 grid-cols-1 grid-rows-3 gap-16 align-center">
        {features.map((feature, idx) => (
          ...
          >
            ...
            <p className="text-center text-xl md:text-2xl font-semibold">{feature.title}</p>
          </motion.div>
        ))}
      </div>
    </div>
